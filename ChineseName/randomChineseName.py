...
class getRandomChineseName:
    ...
    def getRandomChineseName(self):
        ...
        last_name = random.choice(self.last_name) if long == 2 else "{}{}".format(random.choice(self.last_name),
...
if __name__ == '__main__':
    print(getRandomChineseName().getRandomChineseName())
